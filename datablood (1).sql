...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2019 at 09:07 AM
...
(27, 'B-', 'Uttar Pradesh', 'delhi', 'Blood Bank, Santosh Medical & Dental College Hospital,\r\nNo. 1, Ambedkar Road, Ghaziabad\r\n', 'No. 1, Ambedkar Road, Ghaziabad', 'bloodbook.php'),
(34, 'B+', 'Uttar Pradesh', 'delhi', 'Blood Bank, Santosh Medical & Dental College Hospital,\r\nNo. 1, Ambedkar Road, Ghaziabad\r\n', 'No. 1, Ambedkar Road, Ghaziabad', 'bloodbook.php'),
(35, 'O+', 'Uttar Pradesh', 'Noida', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(36, 'A+', 'Uttar Pradesh', 'Noida', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(37, 'B+', 'Uttar Pradesh', 'Noida', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(38, 'AB+', 'Uttar Pradesh', 'Noida', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(39, 'O-', 'Uttar Pradesh', 'Noida', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(40, 'A-', 'Uttar Pradesh', 'Noida', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(41, 'B-', 'Uttar Pradesh', 'Noida', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(42, 'AB-', 'Uttar Pradesh', 'Noida', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(43, 'AB-', 'Uttar Pradesh', 'Delhi', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(44, 'B-', 'Uttar Pradesh', 'Delhi', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(45, 'A-', 'Uttar Pradesh', 'Delhi', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(46, 'O-', 'Uttar Pradesh', 'Delhi', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(47, 'AB+', 'Uttar Pradesh', 'Delhi', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(48, 'B+', 'Uttar Pradesh', 'Delhi', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(49, 'A+', 'Uttar Pradesh', 'Delhi', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(50, 'O+', 'Uttar Pradesh', 'Delhi', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(51, 'AB-', 'Uttar Pradesh', 'Gurugram', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(52, 'B-', 'Uttar Pradesh', 'Gurugram', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(53, 'A-', 'Uttar Pradesh', 'Gurugram', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(54, 'O-', 'Uttar Pradesh', 'Gurugram', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(55, 'AB+', 'Uttar Pradesh', 'Gurugram', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(56, 'B+', 'Uttar Pradesh', 'Gurugram', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(57, 'A+', 'Uttar Pradesh', 'Gurugram', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php'),
(58, 'O+', 'Uttar Pradesh', 'Gurugram', 'MMg Hospital Bank', 'Noida ', 'bloodbook.php');
...
--
-- Table structure for table `datahospital`
--

CREATE TABLE `datahospital` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `address` varchar(255) NOT NULL,
  `aadhar` int(255) NOT NULL,
...
--
-- Indexes for table `datahospital`
--
ALTER TABLE `datahospital`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `datahospital`
--
ALTER TABLE `datahospital`
